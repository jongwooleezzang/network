...
class LoginGUI extends JFrame implements ActionListener ,KeyListener {
	...
	JLabel NickName_Label = new JLabel("유저 이름 입력");
	JLabel Port_Label = new JLabel("포트(0000) 입력");
	JLabel IPAddress_Label = new JLabel("IP 주소 입력");
	...
	public LoginGUI() {
		...
		setResizable(true);
		setVisible(true);
		Login_GUI_Button.setPreferredSize(new Dimension(100, 30));
